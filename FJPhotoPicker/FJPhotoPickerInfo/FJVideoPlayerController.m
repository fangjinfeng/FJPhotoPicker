...
@interface FJVideoPlayerController () {
    AVPlayer *_player;
...
@implementation FJVideoPlayerController
...
- (void)configMoviePlayer {
    [[FJImageManager manager] getPhotoWithAsset:_model.asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
        _cover = photo;
    }];
    [[FJImageManager manager] getVideoWithAsset:_model.asset completion:^(AVPlayerItem *playerItem, NSDictionary *info) {
...
- (void)viewDidLayoutSubviews {
    ...
    _playerLayer.frame = self.view.bounds;
    _playButton.frame = CGRectMake(0, 64, self.view.fj_width, self.view.fj_height - 64 - 44);
