...
@implementation FJPhotoAblumList


@end

@implementation FJPhotoTool

static FJPhotoTool *sharePhotoTool = nil;
...
- (NSArray<FJPhotoAblumList *> *)getPhotoAblumList
{
    NSMutableArray<FJPhotoAblumList *> *photoAblumList = [NSMutableArray array];
    ...
    [smartAlbums enumerateObjectsUsingBlock:^(PHAssetCollection * _Nonnull collection, NSUInteger idx, BOOL *stop) {
        ...
        if(collection.assetCollectionSubtype != 202 && collection.assetCollectionSubtype < 212){
            ...
            if (assets.count > 0) {
                FJPhotoAblumList *ablum = [[FJPhotoAblumList alloc] init];
